...
public class ProductCommentServiceImpl implements ProductCommentService {
    ...
    public ProductCommentProduceDto getCommentByProductId(Long id) {
        ...
        List<ProductCommentEntity> productCommentEntityList = (List<ProductCommentEntity>) productEntity.getProductComments();
        productCommentEntityList.stream().map(mProductCommentMapper::toProductCommentProduceDto).collect(Collectors.toList());

        return toProductCommentProduceDto((ProductCommentEntity) productCommentEntityList);
    }
}
